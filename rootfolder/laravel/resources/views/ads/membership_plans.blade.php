							...
							<nav class="nav-main">
								...
								<ul id="topMain" class="nav nav-pills nav-main">
									<li class="active"><!-- HOME -->
										<a href="{{URL::to('home')}}"><i class="fa fa-home fa-lg"></i> HOME </a>
									</li>
									<!-- QUICK SHOP CART -->
									<li class="quick-cart">
										<a href="#">
					...
					<div class="row">
						<div class="col-md-4 col-sm-4 regular_box">
							<div class="price-clean">
								...
								<hr />
								<a href="{{URL::to('freepost')}}" class="btn btn-3d btn-lg btn-teal">Just Post My Ad</a>
						...
						<div class="col-md-4 col-sm-4 promo_box">
							...
							<div class="col-md-8 featured_details" style="display:none;">
								...
								<div class="row">
									...
									<button type="button" class="btn btn-lg selected_btn payment_btn"><i class="fa fa-shopping-cart"></i> Continue to Payment</button>
									</div>
								</div>
