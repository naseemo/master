...
@if(count($errors)>0)
			...
			<section class="postform nopadding">
				...
				<form method="POST" enctype="multipart/form-data" action="{{URL::to('/savePost')}}">
				<div class="col-md-12">
				...
				<!-- Step One Start-->
					...
					<div class="col-md-8">
						...
						<div class="col-md-12 clearboth adlocationbar size-12 margin-bottom-10" style="background:none; border:0;">
							...
							<i class="fa fa-map-marker nopadding"></i> {{ Session::get('cityname') }} <i class="fa fa-calendar"></i> {{ date('Y-M-d') }} <i class="fa fa-eye"></i> 123456 <i class="fa fa-heart"></i> 123
							</div>
						</div>
