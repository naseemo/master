...
$del_q = mysqli_query($db, "DELETE FROM `pages` WHERE `id`='".str_replace(' ', '', $_REQUEST['id'])."'");	
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
							...
							<div class="page-title-actions">
                                <a href="add_page.php" data-toggle="tooltip" title="" data-placement="top" class="mr-3 btn btn-dark" data-original-title="Add New">
					...
					<div class="main-card mb-3 card">
                        <div class="card-body">
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
								<?php
								$sales_q = mysqli_query($db, "SELECT * FROM `pages`");
								while($sales_f = mysqli_fetch_assoc($sales_q)){
									
								if($sales_f['status'] == '0'){
								$status = '<i class="fa fa-hourglass"></i> Unpublished';
								} else if($sales_f['status'] == '1'){
								$status = '<i class="fa fa-check text-success"></i> Published';
								}
								?>
                                <tr>
                                    <td><?php echo $sales_f['page_name'];?></td>
                                    <td><?php echo $sales_f['seo_title'];?></td>
									...
									<div class="d-inline-block dropdown">
										...
										<h6 tabindex="-1" class="dropdown-header">Manage This Page</h6>
											<a type="button" tabindex="0" class="dropdown-item" href="add_page.php?id=<?php echo $sales_f['id'];?>"><i class="dropdown-icon fa fa-check"> </i>Edit</a>
