				...
				<div class="container">
					...
					<div class="row visible-xs">
						...
						<div class="col-md-12 mainsearch">
							...
							$m++;
							?>
							<button type="button" class="btn btn-default block mobcats"><a href="categories.php?id=<?php echo $momain_f['id'];?>" class="block text-black"><i class="fa fa-<?php echo $momain_f['subc_desciptions'];?> fa fa-fa fa-plug margin-bottom-10 block" style="font-size: 36px;"></i> <?php echo $momain_f['subc_name'];?></a></button>
							<?php } ?>
						</div>
