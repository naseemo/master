...
$func_q = mysqli_query($db, "SELECT * FROM `ads_attributes` WHERE `attribute_set`='".$set_f['subc_attribute_set']."' AND `input_type` NOT IN ('checkbox', 'image') AND `required`='0'");
...
<div class="row bgrow">
		...
		<select class="form-control <?php echo $func_f['attr_class'];?>" style="width:100%;" name="attr_<?php echo $func_f['id']; ?>" id="attr_<?php echo $func_f['id']; ?>" data-ng-model="city" <?php if($func_f['required'] == '1'){?> required="" <?php } ?>>
...
<div class="row bgrow">
		...
		<div class="fancy-form"><!-- input -->
			...
			<input type="text" class="form-control <?php echo $func_f['attr_class'];?>" name="attr_<?php echo $func_f['id'];?>" id="attr_<?php echo $func_f['id'];?>" placeholder="<?php echo $func_f['attr_placeholder']; ?>" <?php if($func_f['required'] == '1'){?> required="" <?php } ?> <?php if($numerplates == '1'){?> onkeyup="<?php echo $functionname;?>();" <?php } ?> />
...
<div class="row bgrow">
		...
		<div class="fancy-form"><!-- input -->
			<i class="<?php echo $func_f['attr_icon'];?>"></i>
			<input type="number" class="form-control stepper <?php echo $func_f['attr_class'];?>" min="0" max="1000" name="attr_<?php echo $func_f['id'];?>" id="attr_<?php echo $func_f['id'];?>" placeholder="<?php echo $func_f['attr_placeholder']; ?>" <?php if($func_f['required'] == '1'){?> required="" <?php } ?> value="<?php echo $func_f['attr_values'];?>" />
			<span class="fancy-tooltip top-left"> <!-- positions: .top-left | .top-right -->
...
<div class="row bgrow">
		...
		<div class="fancy-form"><!-- input -->
			<i class="<?php echo $func_f['attr_icon'];?>"></i>
			<input type="date" class="form-control <?php echo $func_f['attr_class'];?> datepicker" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false" name="attr_<?php echo $func_f['id'];?>" id="attr_<?php echo $func_f['id'];?>" placeholder="<?php echo $func_f['attr_placeholder']; ?>" <?php if($func_f['required'] == '1'){?> required="" <?php } ?> value="<?php echo $func_f['attr_values'];?>" />
			<span class="fancy-tooltip top-left"> <!-- positions: .top-left | .top-right -->
				<em>Type <?php echo $func_f['attr_placeholder']; ?></em>
			</span>
		</div><!-- /input -->
...
<?php } else if($func_f['input_type'] == 'file' || $func_f['input_type'] == 'image'){ ?>
<div class="row bgrow">
		<div class="col-md-3 padding-top-10">
		<label class="size-15"><?php echo $func_f['attr_label'];?> <?php if($func_f['required'] == '1'){?><span class="text-danger">*</span><?php } ?></label>
		</div>
...
//FOR CHECKBOXES SETS ONLY
$check_q = mysqli_query($db, "SELECT * FROM `ads_attributes` WHERE `input_type`='checkbox' AND `attribute_set`='".$set_f['subc_attribute_set']."' AND `input_type`='checkbox'");
$check_num = mysqli_num_rows($check_q);
if($check_num > 0){
?>
<div class="row bgrow">
		<div class="col-md-3 padding-top-10">
		<label class="size-15">Extra Features <?php if($func_f['required'] == '1'){?><span class="text-danger">*</span><?php } ?></label>
		</div>
		<div class="col-md-9 margin-bottom-10" style="padding-left: 0;">
		<?php
		
		while($check_f = mysqli_fetch_assoc($check_q)){
		?>
		<label class="checkbox nomargin col-md-6"><input class="checked-agree <?php echo $check_f['attr_class'];?>" type="checkbox" name="attr_<?php echo $check_f['id'];?>" id="attr_<?php echo $check_f['id'];?>" value="<?php echo $check_f['attr_values'];?>" <?php if($check_f['required'] == '1'){?> required="" <?php } ?> ><i></i> <?php echo $check_f['attr_label'];?></label>
		<?php } ?>
		</div>
</div>
<?php } ?>
