					...
					<div class="row">
								<div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3">
									...
									<div class="box-static box-transparent box-bordered padding-30" style="background:#FFF;">
											...
											<div class="row">
												...
												<div class="col-md-6 col-sm-6 col-xs-6">
													...
													<div class="form-tip pt-20">
														<a class="no-text-decoration size-13 margin-top-10 block" href="forgot_password.php">Forgot Password?</a>
													</div>
										...
										<hr />
										<div class="text-center">
											Don't have an account yet? <a href="membership_plans.php"><strong>Click to register!</strong></a>
										</div>
