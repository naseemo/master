				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
									...
									<input type="text" class="form-control" name="search_value" id="search_value" placeholder="I'm looking for..." style="height:42px !important;" required="" />
									</div>
									<div class="col-md-2 margin-bottom-10">
									<div class="fancy-form fancy-form-select" style="width:100%;">
										<select class="form-control select2" style="width:100%; line-height: 23px !important" name="city" id="city">
									...
									<div class="col-md-2 margin-bottom-10">
									<div class="fancy-form fancy-form-select" style="width:100%;">
										<select class="form-control select2" name="category" style="width:100%; line-height: 23px !important">
									...
									<div class="fancy-form fancy-form-select sortfilter" style="width:100%;">
										<select class="form-control select2" style="width:100%;font-size: 12px !important;border-radius: 5px;border-color: rgba(51, 51, 51, 0.2);cursor: pointer;background: linear-gradient( #fff 20%, #f6f6f6 50%, #eee 52%, #f4f4f4 100%);font-weight: 400;">
										...
										<!--
											...
											.fancy-arrow-double
										-->
										<i class="fancy-arrow" style="top:13px !important;"></i>
									</div>
									</div>
				...
				<div class="container">
					...
					<?php }?>
						...
						<?php $imgstatus = adsController::checkImge($adDet->attr_id);?>
							...
							<img src="{{ asset('/media/'.$adDet->attr_values.'') }}" style="width: 100%;">
							</div>
							<?php $flag++;?>
							@endif
							@endif
						...
						<ul class="pagination">
							...
							<li class="<?php echo $class; ?>"><a href="{{URL::to('listingsAds/'.$id.'/'.$cat_id.'/'.$i)}}">{{$i}}</a></li>
								<?php }?>
