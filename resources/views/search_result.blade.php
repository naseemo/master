			...
			<section class="nopadding">
				<div class="container">
					...
					<?php }?>
											...
											@if($imgstatus!='image' && $adDet->is_home)
												<tr>
						...
						<ul class="pagination">
							...
							<li class="<?php echo $class; ?>"><a href="{{URL::to('listing/'.$i)}}">{{$i}}</a></li>
								<?php }?>
...
<!-- Report Ad -->
	...
	if(id !== '0'){	
	var current_level = Number(document.getElementById('maxlevel').value) + Number('1');
		$.ajaxSetup({
			headers: 	{
