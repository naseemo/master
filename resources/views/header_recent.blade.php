						...
						<div class="navbar-collapse pull-right nav-main-collapse collapse submenu-dark">
							<nav class="nav-main">
								...
								<ul id="topMain" class="nav nav-pills nav-main">
									...
									<li>
										<a href="{{ URL::to('membership') }}"><i class="fa fa-user"></i> Membership</a>
									</li>	
									@endif
									<!--<li>
									...
									<li class="quick-cart">
										...
										@if(!Session::get('logedstatus')==1)
											...
											<i class="fa fa-sign-in"></i> Login <i class="fa fa-angle-down"></i>
											</a>
										@endif
										@if(Session::get('logedstatus')==1)
											
											<!--<span class="badge btn-xs badge-corner">1</span>-->
											<i class="fa fa-user"></i> {{Str::ucfirst(Session::get('username'))}} <i class="fa fa-angle-down"></i>
									...
									<li class="search">
										<a href="javascript:;" class="nopadding">
											<i class="fa selectlocationicon" style="padding: 10px 15px;padding-right: 5px;"> <img src="{{ asset('images').'/'.Session::get('contFlag') }}" alt="Local Classifieds" /> </i> <i class="fa fa-angle-down" style="padding: 15px 10px 15px 0px;"></i>
										</a>
										...
										<h4><i class="fa fa-map-marker"></i> Your location</h4>
										 @foreach($country as $country)
											<div class="col-md-6 col-xs-12">
											   <a href="#"><img src="{{ asset('images/'.$country->ct_image) }}" alt="{{$country->ct_name}}" /> All in {{$country->ct_name}}</a>
												<?php $cities = locationsController::getCities($country->id);?>
												 @foreach($cities as $cities)
												<a href="#"><i class="fa fa-caret-right"></i> {{$cities->lc_name}}</a>
												@endforeach
											</div>
											@endforeach
										</div> 
