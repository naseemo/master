	...
	<body class="smoothscroll enable-animation">
		...
		@include('header')
			...
			<section class="nopadding">
				<div class="container">
				<h2>About Us</h2>
<p><span>Naseemo.com is one of the leading classifieds website for buyers &amp; sellers in the UAE. It is recently launched in 2019, Naseemo.com is rapidly growing due the unique services it provides to attract users. Naseemo encourages sellers to list any type of either product or services. Not only Used products but New ones have a place in our community. Naseemo was built with a smart categorization solution in order to allow users to list <i>“the right Ad in the Right Place on the Right way”.</i></span></p>
<p><span>Naseemo is a free zone company Based in Dubai, UAE. Owned &amp; founded by Ghassan Kharouf. Naseemo is expected to increase the growth to the MENA region. Targeting Millions of viewers per month.</span></p>
				</div>
			</section>
