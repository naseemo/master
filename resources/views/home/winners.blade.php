		...
		<div id="wrapper">
			...
			<section class="page-header page-header-xs dark" style="display:none;">
				<div class="container">
					...
					<ol class="breadcrumb">
						<li><a href="/">Home</a></li>
						<li class="active"><a href="{{ URL::to('luckydraw') }}">Lucky Draw</a></li>
					</ol><!-- /breadcrumbs -->
			...
			<!-- -->
			<section class="nopadding" style="background: url( {{ asset('images/backgrounds/bg1-min.jpg') }}); background-attachment: fixed;">
				<div class="container">
				...
				<div class="row">
						<div class="col-md-8">
								...
								<table class="table table-bordered" style="background: rgba(255,255,255,0.8);">
									...
									<?php $total+=$winnersArr->ticket_price;?>
									<tr>
										<td>{{$i}}</td>
										<td><a href="{{URL::to('public-profile/'.$winnersArr->regid)}}" class="text-default size-16 bold"><i class="fa fa-user"></i> {{$winnersArr->firstname}} {{$winnersArr->lastname}}</a></td>
										<td><small class="text-default font-weight-normal size-13"><i class="fa fa-ticket"></i> {{$winnersArr->ticket_no}}</small></td>
										<td><small class="text-red size-13"><i class="fa fa-trophy"></i> {{$winnersArr->ticket_price}}</small></td>
										<td><?php echo date('M-Y',strtotime($winnersArr->created_at))?></td>
									</tr>
									<?php $i=$i+1;?>
									@endforeach
									<tr>
										<td colspan="3" align="right"><strong>Total Winning Amount</strong></td>
										<td class="text-primary size-16 bold">{{$total}} (AED)</td>
									</tr>
