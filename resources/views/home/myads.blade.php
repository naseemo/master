							...
							<table class="table table-hover ">
									...
									@foreach($adsArr as $adsArr)
										<tr>
											...
											<a class="btn btn-xs btn-default block margin-bottom-5" href="{{ URL::to('ad_edit/'.$adsArr->id)}}"><i class="fa fa-pencil"></i> Edit</a>
										    ...
										    @else
												<a class="btn btn-xs btn-default block margin-bottom-5 "><i class="fa fa-refresh"></i> Re-Publish</a></td>
											@endif
										</tr>
								@endforeach
									</tbody>
