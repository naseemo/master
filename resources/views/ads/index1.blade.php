				...
				<!-- Step One Start-->
					...
					<div class="col-md-9">
						<div class="row margin-bottom-30 bgrow">
							...
							<div class="col-md-9">
								<input type="text" class="form-control " placeholder="Enter your ad title here" data-ng-model="title" required="" maxlength="60" name="title" id="title"/>
							</div>
						</div>
						...
						<div class="row bgrow alert alert-warning" style="margin-top: 20px !important;margin-right: 15px !important;">
							<div class="col-md-3 padding-top-10">
							<label style="font-weight: bold !important;font-size: 16px !important;">Our Opinion</label>
							<p class="text-black size-12">AS PER OUR OPINION THE PRICE FOR THIS ITEM YOU ENTERED IS:</p>
							</div>
							<div class="col-md-9">
								<!-- input -->
								<div class="fancy-form">
						...
						<div class="col-md-12 clearboth adlocationbar size-12 margin-bottom-10" style="background:none; border:0;">
							...
							<small style="font-weight: normal;font-size: 12px;">AED</small> <span data-ng-bind="item_price"></span>
							</div>
						</div>
