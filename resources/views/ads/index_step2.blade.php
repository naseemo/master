...
<!-- MOBILE MENU BOTTOM -->
			...
			<div class="clearboth margin-bottom-20"></div>
					<!-- Recent Ads -->
			<?php
			$cat_name = $category_details->subc_name;
			?>
			<section class="postform nopadding">
				...
				<!-- Step One Start-->
						<div class="clearboth"></div>
						<div class="selected_text col-md-12 nopadding" style="margin-top: 20px;">
						<div class="text-left col-md-12 alert margin-bottom-30"><h3 class="text-black nomargin nopadding text-centerr size-20" style=""><i class="fa fa-check-circle"></i> {{$cat_name}}<a type="button" href="/adPost" class="btn btn-xs size-14 text-default"><i class="fa fa-pencil"></i> Change Category</a></h3><p class="size-13 nopadding">You have selected the category successfully please move to next steps.</p></div>
						</div>	
					...
					<div class="col-md-9">
						<div class="row margin-bottom-30 bgrow">
							...
							<div class="col-md-9">
								<input type="text" class="form-control title" placeholder="Enter your ad title here" data-ng-model="title" required="" maxlength="60" name="title" id="title" value="{{old('title')}}"/>
							</div>
						</div>
						<div class="row  margin-bottom-10 bgrow">
							...
							<div class="col-md-9">
								...
								<div class="fancy-form">
									<textarea class="form-control size-15 ad_desc" name="ad_desc" id="ad_desc" placeholder="Write your ad details here..." required="" maxlength="2000" data-ng-maxlength="2000" data-ng-model="ad_desc" style="min-height:250px;">{{old('ad_desc')}}</textarea>
						...
						<div class="row price_row bgrow">
							...
							<div class="col-md-9">
								...
								<div class="fancy-form">
									...
									<input type="text" class="form-control size-15 font-bold" name="item_price" id="item_price" required="" style="padding-left: 50px;" maxlength="8" value="{{old('item_price')}}">
						...
						<div class="row bgrow alert alert-warning opinion_check" style="margin-top: 20px !important;margin-right: 15px !important; display:none;">
							...
							<div class="col-md-9">
								...
								<div class="fancy-form">
									...
									<span id="item1_price"  class="form-control size-15 font-bold" style="padding-left: 70px;background: none !important;border: none;color: #c00;font-size: 20px !important;"></span>
								</div>
						...
						<div class="row attributes" >
							...
							<?php
							$button=adsController::getAttributepost($cat_id);
							?>
							{!!$button!!}
							</div>	
							...
							<div class="toggle toggle-transparent toggle-bordered-simple nomargin nopadding">
								<div class="toggle nomargin nopadding">
									...
									<div class="toggle-content">
										...
										<?php
							$button=adsController::getAttributeHiddenpro($cat_id);
							?>
							{!!$button!!}
										</div>
									</div>
						...
						<div class="col-md-12 margin-top-20 clearboth">
							...
							<div class="row">	
								...
								<select class="form-control " style="width:100%;" name="city" id="city" data-ng-model="city" required="">
									...
									<option value="{{$locations->id}}" <?php if($locations->id==$request->session()->get('location')) {?> selected="" <?php }?>>{{$locations->lc_name}}</option>
								    @endforeach
								</select>
								</div>
								<div class="col-md-4 hidden-xs"></div>
						...
						<div class="row submit_btn margin-bottom-50 margin-top-30">
								...
								<div class="col-md-6 hidden">
									<div class="col-md-12">
									<label class="checkbox nomargin font-weight-normal"><input class="checked-agree" type="checkbox" name="terms" id="terms" value="1"><i></i>I agree to the <a href="#" data-toggle="modal" data-target="#termsModal">Terms of Service</a></label>
									</div>
									<div class="col-md-12">
								...
								<div class="col-md-12 text-center">
									...
									<button type="submit" class="btn btn-xlg btn-primary" style="padding: 15px 30px;">Submit & Continue </button>
									</div>
								</div>
		...
		$.ajaxSetup({
		   ...
		   if($("#attr_299").val()!=null && $("#attr_299").val()!="")
			 ...
			 success: function (response) {
				...
				if(response == '0')
					{
					document.getElementById("item1_price").innerHTML = "No data found ";
					} 
					else 
					{
					...
					{
					document.getElementById("item1_price").innerHTML='High <i class="fa fa-warning"></i>';
					}
					if(eval(price)>eval(lprice) && eval(price)<=eval(avg))
					{
					document.getElementById("item1_price").innerHTML='Fair <i class="fa fa-thumbs-o-up"></i>';
					}
					if(eval(price)<eval(lprice) || eval(price)>eval(upprice))
					{
					document.getElementById("item1_price").innerHTML='Low <i class="fa fa-frown-o"></i>';
					}
