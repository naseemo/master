...
class testController extends Controller
{
	...
	public function testAjax()
	{
		...
		*/
		...
		$objSubcat=new Services();
		$arr=Services::where([['svs_parent_id',11125]])->get();
		
		foreach($arr as $arr)
		{
			$objSubca=new Subcategories();
			$objSubca->subc_parent_id=12226;
			$objSubca->subc_code=$arr->svs_code;
			$objSubca->subc_name=$arr->svs_name;
