...
*************************************************** **/
	...
	jQuery(window).ready(function () {
		...
		// Load Bootstrap JS
		loadScript('https://naseemo.com/public/plugins/bootstrap/js/bootstrap.min.js', function() {
		...
		if(jQuery("html").hasClass("chrome") && jQuery("body").hasClass("smoothscroll")) {
			loadScript('https://naseemo.com/public/plugins/smoothscroll.js', function() {
				jQuery.smoothScroll();
			});
		}
		/* --- */
 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		if(_container.length > 0) {
			...
			loadScript('https://naseemo.com/public/plugins/owl-carousel/owl.carousel.min.js', function() {
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript('https://naseemo.com/public/plugins/form.validate/jquery.form.min.js', function() {
				loadScript('https://naseemo.com/public/plugins/form.validate/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript('https://naseemo.com/public/plugins/form.validate/jquery.form.min.js', function() {
				loadScript('https://naseemo.com/public/plugins/form.validate/jquery.validation.min.js', function() {
 ...
 **************************************************************** **/
	...
	function format_twitter(twitt) {
		...
		for(var i=0; i<twitt.length; i++) {
			...
			statusHTML.push('<li><i class="fa fa-twitter"></i><span>'+status+'</span><small><a href="https://twitter.com/'+username+'/statuses/'+twitt[i].id_str+'" target="_blank">'+relative_time(twitt[i].created_at)+'</a></small></li>');
		}
