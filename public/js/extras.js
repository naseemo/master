...
$.ajax({
type: 'POST',
url: 'https://naseemo.com/getSubcategoryForAd',
data: {
id: cat_id,
level: level,
},
...
$.ajax({
type: 'POST',
url: 'https://naseemo.com/getAttribute',
data: {
id: id,
},
success: function (response) {
...
$.ajax({
type: 'POST',
url: 'https://naseemo.com/getAttributeHidden',
data: {
id: id,
},
success: function (response) {
...
//$('.attr_values').html('');
function attrvalues(attr, label){
var i = attr;
	$('.attr_'+i+'_value').html('');
	if($('.attr_'+i).val() == ''){
		$('.attr_'+i+'_value').html('');
	} else {
	$('.attr_'+i+'_value').html('<i class="fa fa-caret-right padding-6"></i>'+ label + ': ' + $('.attr_'+i).val());
	}	
} 