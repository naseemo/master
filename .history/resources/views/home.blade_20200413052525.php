					...
					<div class="row margin-bottom-30">
						<div class="col-md-12 mainsearch">
								<div class="row">
									...
									<input type="text" class="form-control" name="search_value" id="search_value" placeholder="<?php  echo ucwords(strtolower($cityName)); ?> " autocomplete="off" style="border-radius: 50px 0px 0px 50px;" />
									</div>
									</div>
